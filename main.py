...
if __name__ == '__main__':
    ...
    values = [10, "число", 4, 9] # list - список элементов, обычно в квадратных скобках, нумерация значений начинается с нуля!
    list_dictionary = {0: 10, 1: "число", 2: 4, 3: 9}
    dictionary = {"car": "машина", "dog": "собака", "cat": "кошка"} # dictionary - словарь, в нем перечисляются пары "ключ": "значение"
